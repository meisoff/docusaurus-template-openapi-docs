module.exports = [{
    ...
    "items": [{
        ...
        "className": "api-method post"
    }, {"type": "doc", "id": "nopaper-api/4", "label": "Отправить документ в работу", "className": "api-method post"}]
}, {
    "type": "category",
    ...
    "items": [{
        "type": "doc",
        "id": "nopaper-api/5",
        "label": "Получить список исходящих и входящих документов с использованием фильтров",
        "className": "api-method get"
    }, {
        "type": "doc",
        "id": "nopaper-api/6",
        ...
        "className": "api-method post"
    }, {"type": "doc", "id": "nopaper-api/9", "label": "Получить подписи файлов", "className": "api-method get"}]
}, {
    "type": "category",
